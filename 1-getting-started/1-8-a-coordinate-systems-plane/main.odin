package main
/*
CHAPTER: 1-8-a COORDINATE SYSTEMS (PLANE)
TUTORIAL: https://learnopengl.com/Getting-started/Coordinate-Systems
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/6.1.coordinate_systems/coordinate_systems.cpp
*/
...
main::proc(){
	...
	for !glfw.WindowShouldClose(window){
        ...
        model:glm.mat4 = glm.mat4(1.0) // make sure to initialize matrix to identity matrix first
        view:glm.mat4 = glm.mat4(1.0) 
        projection:glm.mat4 = glm.mat4(1.0)
		model = model * glm.mat4Rotate({1.0,0.0,0.0},glm.radians_f32(-55))
