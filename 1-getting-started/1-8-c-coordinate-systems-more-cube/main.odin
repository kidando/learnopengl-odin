package main
/*
CHAPTER: 1-8-c COORDINATE SYSTEMS (MORE CUBES)
TUTORIAL: https://learnopengl.com/Getting-started/Coordinate-Systems
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/6.3.coordinate_systems_multiple/coordinate_systems_multiple.cpp
*/
...
main::proc(){
	...
	for !glfw.WindowShouldClose(window){
		...
		// retrieve the matrix uniform locations and pass transformation matrices to the shader
