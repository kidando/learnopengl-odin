package main
/*
CHAPTER: 1-4 b HELLO RECTANGLE
TUTORIAL: https://learnopengl.com/Getting-started/Hello-Triangle
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/1.getting_started/2.2.hello_triangle_indexed/hello_triangle_indexed.cpp
*/
...
main::proc(){
	...
	*/
	...
	for !glfw.WindowShouldClose(window){
		...
		/*
		note how the final parameter is nil as opposed to 0 in C++
		*/
