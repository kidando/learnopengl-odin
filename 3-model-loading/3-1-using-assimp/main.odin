package main
/*
CHAPTER: 3-2 Model "Class"
TUTORIAL: https://learnopengl.com/Model-Loading/Model
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/3.model_loading/1.model_loading/model_loading.cpp
*/
...
main::proc(){
    ...
    // ------------------------------------
    ourShader, ourShaderOk := shader_init("./shaders/model_loading.vs","./shaders/model_loading.fs")
	if !ourShaderOk{
		return
	}
    ...
    // -----------
	ourModel:Model
	defer model_destroy(&ourModel)
	model_load(&ourModel,"./assets/models/backpack/backpack.obj")
