package main
/*
CHAPTER: 4-7-2 Geometry Shader Exploding
TUTORIAL: https://learnopengl.com/Advanced-OpenGL/Geometry-Shader
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/4.advanced_opengl/9.2.geometry_shader_exploding/geometry_shader_exploding.cpp
*/
...
main::proc(){
    ...
    // ------------------------------------
    shader, shaderOk := shader_init("./shaders/geometry_shader.vs","./shaders/geometry_shader.fs","./shaders/geometry_shader.gs")
	if !shaderOk{
		return
	}
	...
	monkey:Model
	ai_load_gltf_model(&monkey, "./assets/models/monkey/monkey.gltf")
	ai_setup_model_for_gpu(&monkey)
	defer ai_destroy_model(&monkey)
	...
	for !glfw.WindowShouldClose(window){
		...
		shader_set_float(shader,"time",currentFrame)

		ai_draw_model(&monkey, shader)
