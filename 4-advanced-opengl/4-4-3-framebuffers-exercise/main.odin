package main
/*
CHAPTER: 4-4-3 Framebuffers Exercise
TUTORIAL: https://learnopengl.com/Advanced-OpenGL/Framebuffers
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/4.advanced_opengl/5.2.framebuffers_exercise1/framebuffers_exercise1.cpp
*/
...
main::proc(){
	...
	for !glfw.WindowShouldClose(window){
		...
		mainCamera.yaw += 180
		camera_process_mouse_movement(&mainCamera,0,0,false)
		view:glm.mat4 = camera_get_view_matrix(&mainCamera)
		mainCamera.yaw -= 180
		camera_process_mouse_movement(&mainCamera,0,0,true)
		...
		model = glm.mat4(1.0)
		view = camera_get_view_matrix(&mainCamera)
		shader_set_mat4(shader,"view",&view[0][0])
