package main
/*
CHAPTER: 2-2-a Basic Lighting (Ambient + Diffuse)
TUTORIAL: https://learnopengl.com/Lighting/Basic-Lighting
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/2.1.basic_lighting_diffuse/basic_lighting_diffuse.cpp
*/
...
main::proc(){
    ...
    // ------------------------------------
    lightingShader, lightingShaderOk := shader_init("./shaders/basic_lighting.vs","./shaders/basic_lighting.fs")
	if !lightingShaderOk{
		return
	}
	...
	for !glfw.WindowShouldClose(window){
		...
		shader_set_vec3_f32(lightingShader,"objectColor",1.0,0.5,0.31)
		shader_set_vec3_f32(lightingShader,"lightColor",1.0,1.0,1.0)
		shader_set_vec3_vec(lightingShader,"lightPos",&lightPos[0])
