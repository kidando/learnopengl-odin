package main
/*
CHAPTER: 2-4-b Lighting Maps (Specular)
TUTORIAL: https://learnopengl.com/Lighting/Lighting-maps
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/4.2.lighting_maps_specular_map/lighting_maps_specular.cpp
*/
