...
main::proc(){
	...
	for !glfw.WindowShouldClose(window){
		...
		gl.UseProgram(lightingShader)
		shader_set_vec3_vec(lightingShader,"light.position",&mainCamera.position[0])
		shader_set_vec3_vec(lightingShader,"light.direction",&mainCamera.front[0])
		shader_set_float(lightingShader,"light.cutOff",glm.cos_f32(glm.radians_f32(12.5)))
		shader_set_float(lightingShader,"light.outerCutOff",glm.cos_f32(glm.radians_f32(17.5)))
		shader_set_vec3_vec(lightingShader,"viewPos",&mainCamera.position[0])
    
        // light properties
		shader_set_vec3_f32(lightingShader,"light.ambient",0.1,0.1,0.1)
		// we configure the diffuse intensity slightly higher; the right lighting conditions differ with each lighting method and environment.
		// each environment and lighting type requires some tweaking to get the best out of your environment.
		shader_set_vec3_f32(lightingShader,"light.diffuse",0.8,0.8,0.8)
