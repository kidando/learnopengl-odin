package main
/*
CHAPTER: 2-4-a Lighting Maps (Diffuse)
TUTORIAL: https://learnopengl.com/Lighting/Lighting-maps
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/4.1.lighting_maps_diffuse_map/lighting_maps_diffuse.cpp
*/
...
main::proc(){
    ...
    // ------------------------------------
    lightingShader, lightingShaderOk := shader_init("./shaders/lighting_maps.vs","./shaders/lighting_maps.fs")
	if !lightingShaderOk{
		return
	}
	...
	for !glfw.WindowShouldClose(window){
        ...
        // material properties
		shader_set_vec3_f32(lightingShader,"material.specular",0.5,0.5,0.5)
		shader_set_float(lightingShader,"material.shininess",64.0)
