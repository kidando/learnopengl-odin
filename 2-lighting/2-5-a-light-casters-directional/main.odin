package main
/*
CHAPTER: 2-5-c Light Casters (Directional)
TUTORIAL: https://learnopengl.com/Lighting/Light-casters
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/5.1.light_casters_directional/light_casters_directional.cpp
*/
...
main::proc(){
	...
	for !glfw.WindowShouldClose(window){
		...
		gl.UseProgram(lightingShader)
		shader_set_vec3_f32(lightingShader,"light.direction",-0.2, -1.0, -0.3)
