...
/*
CHAPTER: 2-1 Colors
TUTORIAL: https://learnopengl.com/Lighting/Colors
SOURCE CODE IN C++: https://learnopengl.com/code_viewer_gh.php?code=src/2.lighting/1.colors/colors.cpp
*/
...
main::proc(){
    ...
    // ------------------------------------
    lightingShader, lightingShaderOk := shader_init("./shaders/colors.vs","./shaders/colors.fs")
	if !lightingShaderOk{
		return
	}
